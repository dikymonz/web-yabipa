...
import StrukturPage from "./pages/kurikulum/StrukturPage";
        ...
        <>
          ...
          <Router>
            ...
            <Routes>
              ...
              <Route
                path="/gallery/gallery-lifeskill"
                Component={LifeSkillPage}
              />
              <Route path="/gallery/gallery-event" Component={EventPage} />
              <Route
                path="/gallery/gallery-graduation"
                Component={GraduationPage}
              />
              <Route
                path="/gallery/gallery-fieldtrip"
                Component={FieldTripPage}
              />
              <Route
                path="/gallery/gallery-munaqosyah"
                Component={MunaqosyahPage}
              />

              {/* Kurikulum Route */}
              <Route path="/kurikulum/struktur" Component={StrukturPage} />
